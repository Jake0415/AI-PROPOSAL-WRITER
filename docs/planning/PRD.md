...
**작성일**: 2026-03-21
**상태**: 승인됨
**변경 이력**: v1.0(2026-03-17) → v2.0(2026-03-18) 수주 최적화 시나리오 12건 반영 → v3.0(2026-03-20) 대화형 AI 파이프라인 추가
...
| F-152 | Vision 하이브리드 분석 | PDF 페이지별 이미지 변환 + GPT-4o Vision으로 표/도표/이미지 분석 |
