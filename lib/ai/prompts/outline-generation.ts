...
## 작성 규칙
1. 이 챕터 하위에 3~8개의 서브섹션(level 2)을 생성하세요.
2. 필요 시 서브-서브섹션(level 3)도 포함하세요.
3. 번호 체계를 제목에 포함하세요 (예: "1.1 사업 개요", "1.1.1 추진 배경").
  ...
  "sections": [
    {
      ...
      "order": 1,
      "children": [
        { "id": "sec-1-1-1", "title": "1.1.1 추진 배경", "level": 3, "order": 1, "children": [] }
      ]
    }
  ]
}`;
