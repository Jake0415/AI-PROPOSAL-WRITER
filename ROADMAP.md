...
| 순서 | #   | 제목           | 규모 | 설명                                   |
| ---- | --- | -------------- | ---- | -------------------------------------- |
| 6    | 044 | 버전 관리 + 비교  | L | 스냅샷/복원 + 타임라인 UI + diff 뷰어  |
| 7    | 033 | 백업/복구         | S | JSON 내보내기/가져오기 + pg_dump        |

### Phase 4: 문서화 (병렬 가능)

| 순서 | #   | 제목           | 규모 | 설명                                   |
| ---- | --- | -------------- | ---- | -------------------------------------- |
| 8    | 036 | 운영 문서         | S | 설치/운영/API/사용자 매뉴얼             |
